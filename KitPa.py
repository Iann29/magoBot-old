...
class KitPaBot:
    ...
    def vender_pa(self, box_name, quantidade=10):
        """Vende uma pá na caixa especificada"""
        return self.vender_item(box_name, "pa", quantidade)

    def vender_kit_pa(self):
        """Gerencia a venda do kit pá (apenas pás)"""
        try:
            # Verifica se está na loja
            if state_manager.get_current_state() != "Dentro da Loja":
            ...
            sequencia_vendas = [
                # Pás (9 caixas)
                {"caixa": "box1", "item": "pa", "quantidade": 10},
                {"caixa": "box2", "item": "pa", "quantidade": 10},
                {"caixa": "box3", "item": "pa", "quantidade": 10},
                {"caixa": "box4", "item": "pa", "quantidade": 10},
                {"caixa": "box5", "item": "pa", "quantidade": 10},
                {"caixa": "box6", "item": "pa", "quantidade": 10},
                {"caixa": "box7", "item": "pa", "quantidade": 10},
                {"caixa": "box8", "item": "pa", "quantidade": 10},
                {"caixa": "box9", "item": "pa", "quantidade": 10}
            ]
            ...
            print(f"Erro ao gerenciar venda de kit pá: {e}")
            return f"Erro: {str(e)}"