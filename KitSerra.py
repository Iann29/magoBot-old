...
class KitSerraBot:
    ...
    def vender_serra(self, box_name, quantidade=10):
        """Vende uma serra na caixa especificada"""
        return self.vender_item(box_name, "serra", quantidade)

    def vender_kit_serra(self):
        """Gerencia a venda do kit serra (apenas serras)"""
        try:
            # Verifica se está na loja
            if state_manager.get_current_state() != "Dentro da Loja":
            ...
            sequencia_vendas = [
                # Serras (9 caixas)
                {"caixa": "box1", "item": "serra", "quantidade": 10},
                {"caixa": "box2", "item": "serra", "quantidade": 10},
                {"caixa": "box3", "item": "serra", "quantidade": 10},
                {"caixa": "box4", "item": "serra", "quantidade": 10},
                {"caixa": "box5", "item": "serra", "quantidade": 10},
                {"caixa": "box6", "item": "serra", "quantidade": 10},
                {"caixa": "box7", "item": "serra", "quantidade": 10},
                {"caixa": "box8", "item": "serra", "quantidade": 10},
                {"caixa": "box9", "item": "serra", "quantidade": 10}
            ]
            ...
            print(f"Erro ao gerenciar venda de kit serra: {e}")
            return f"Erro: {str(e)}"