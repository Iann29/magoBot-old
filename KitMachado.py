...
class KitMachadoBot:
    ...
    def vender_machado(self, box_name, quantidade=10):
        """Vende um machado na caixa especificada"""
        return self.vender_item(box_name, "machado", quantidade)

    def vender_kit_machado(self):
        """Gerencia a venda do kit machado (apenas machados)"""
        try:
            # Verifica se está na loja
            if state_manager.get_current_state() != "Dentro da Loja":
            ...
            sequencia_vendas = [
                # Machados (9 caixas)
                {"caixa": "box1", "item": "machado", "quantidade": 10},
                {"caixa": "box2", "item": "machado", "quantidade": 10},
                {"caixa": "box3", "item": "machado", "quantidade": 10},
                {"caixa": "box4", "item": "machado", "quantidade": 10},
                {"caixa": "box5", "item": "machado", "quantidade": 10},
                {"caixa": "box6", "item": "machado", "quantidade": 10},
                {"caixa": "box7", "item": "machado", "quantidade": 10},
                {"caixa": "box8", "item": "machado", "quantidade": 10},
                {"caixa": "box9", "item": "machado", "quantidade": 10}
            ]
            ...
            print(f"Erro ao gerenciar venda de kit machado: {e}")
            return f"Erro: {str(e)}"